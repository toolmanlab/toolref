...
|------|---------|---------|------------------|------|
| [Knowledge Access Beats Model Size](https://arxiv.org/abs/2603.23013) (2026-03) | 8B+记忆干掉235B无记忆(30.5% vs 13.7% F1)，47%查询语义重复，成本降96% | 语义缓存 | 缓存从"优化"升级为"核心特性"；分级 TTL；系统设计参考 | ✅ 已读 → 待应用 |
